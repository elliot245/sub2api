  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_listingId: 'Listing ID',
        field_paymentMethod: 'Payment Method',
        field_locale: 'Locale',
        field_emailTo: 'Recipient Email',
        field_mintTo: 'Recipient Wallet',
        field_extraPayload: 'Extra Payload JSON',
        ...
        field_crossmintApiBaseHint: 'Use https://staging.crossmint.com/api for staging keys and https://www.crossmint.com/api for production keys.',
        field_crossmintPaymentMethodHint: 'Default fiat. Use Crossmint-supported values such as fiat, crypto, or fiat,crypto according to your checkout configuration.',
        field_crossmintCurrencyHint: 'Default is USD. Choose the settlement/checkout currency configured for this Crossmint listing.',
        field_crossmintExtraPayloadHint: 'Optional JSON object merged into the hosted checkout-link request for advanced Crossmint settings.',
        ...
        crossmintWebhookHint: 'Configure the following URL as a Crossmint Checkout V2 Webhook endpoint and use the signing secret from that endpoint. Enable purchase.succeeded / purchase.failed events; Checkout V3 orders.* events are not supported by this hosted-link integration.',
        crossmintGuideSummary: 'Create a Crossmint server API key with Payments access, then configure the hosted checkout listing/client IDs for fiat and crypto checkout.',
        crossmintGuideNote: 'The first implementation uses hosted checkout links and Checkout V2 passthrough metadata. Sub2API writes the order ID to whPassThroughArgs for payment success/failure reconciliation.',
        limitsTitle: 'Limits',
