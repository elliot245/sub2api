...
import crossmintIcon from '@/assets/icons/crossmint.svg'
...
function methodIcon(type: string): string {
  ...
  if (type === 'crossmint') return METHOD_ICONS.crossmint
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'crossmint') return 'border-[#04D7A0] bg-emerald-50 text-gray-900 shadow-sm dark:bg-emerald-950 dark:text-gray-100'
